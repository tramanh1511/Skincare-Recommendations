...
# df = pd.read_csv('Dash_App_and_Models\skindataall.csv', index_col=[0])

# with open('Dash_App_and_Models\mf_model.pkl', 'rb') as f:
...
#         user_skintone = user_info['Skin_Tone'].iloc[0]
#         user_skintype = user_info['Skin_Type'].iloc[0]
#         user_eyecolor = user_info['Eye_Color'].iloc[0]
#         user_haircolor = user_info['Hair_Color'].iloc[0]
...
#         h_list = [html.H5(f"User: ({user_id}) ({user_name}) ")]
#         h_list.append(html.H6(f"Skin Tone: {user_skintone}"))
#         h_list.append(html.H6(f"Skin Type: {user_skintype}"))
#         h_list.append(html.H6(f"Eye Color: {user_eyecolor}"))
#         h_list.append(html.H6(f"Hair Color: {user_haircolor}"))
#         h_list.append(html.H6("Recommended Products:"))
#         for i in scores:
#             h_list.append(html.H6(i))
