...
from model2 import content_recommender
from model3 import sample_recommendation_user


# image_filename = 'skimage.png'
# encoded_image = base64.b64encode(open(image_filename, 'rb').read())

df = pd.read_csv('Jupyter_Notebook_and_CSV\skindataall.csv', index_col=[0])
...
def content_recommender(product):
    if product not in df_cont['Product'].tolist():
